...
<html>
    ...
    <body>
        ...
        <div class="Connexion">
            ...
            <form action="message_d_inscription.php" method="post" onsubmit="return verifCompletInscription(this)">
        ...
        <div class="Connexion">
            ...
            <form action="connexion_verif.php" method="post" onsubmit="return verifCompletConnexion(this)">
                ...
                <br>
                <input type="password" name="mdpconnexion" placeholder="Mot de passe" oninput="verifMdpC(this)" id="mdp_connexion"><span id="erreur_mdpc"></span>
                <br>
                <br>
                <br>
