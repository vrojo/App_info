...
<html>
    ...
    <body>
		...
		$_POST['heurefin'], nl2br(htmlspecialchars (addslashes($_POST['nb_max_participant']))), nl2br(htmlspecialchars (addslashes($_POST['Nom_e']))), $_POST['privacy'], $_POST['prix'], nl2br(htmlspecialchars (addslashes($_POST['urlsite_event']))));
				...
				upload('photo_principale',$uploadfile1,2000000, array('png','gif','jpg','jpeg','PNG','JPG'));                
               ...
               if ($_FILES['photo_secondaire']['size']!=0) {
				...
				upload('photo_secondaire',$uploadfile2,2000000, array('png','gif','jpg','jpeg','PNG','JPG'));   
				...
				if ($_FILES['photo_trois']['size']!=0) {
					...
					upload('photo_trois',$uploadfile3,2000000, array('png','gif','jpg','jpeg','PNG','JPG'));   	
					...
					if ($_FILES['photo_quatre']['size']!=0) {
						...
						upload('photo_quatre',$uploadfile4,2000000, array('png','gif','jpg','jpeg','PNG','JPG'));   
