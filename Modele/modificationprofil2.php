...
<html>
    ...
    <link type="text/css" rel="stylesheet" href="modificationprofil2.css"/>
    <script type="text/javascript" src="modificationprofil.js"></script>
	
	<body>
        <?php include ("Header.php"); ?>
        <?php $donnees_utilisateur = remplissage_modifprofil(1);
              $donnees_adresse = remplissage_modifprofil_adresse(1);
        ?>
